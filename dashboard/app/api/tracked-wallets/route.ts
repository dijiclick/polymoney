  ...
  try {
    ...
    const wallets = tracked.map(t => {
      ...
      return {
        ...
        best_trade_pct: w?.best_trade_pct ?? null,
        pf_trend: w?.pf_trend ?? null,
        sell_ratio: w?.sell_ratio ?? null,
        trades_per_market: w?.trades_per_market ?? null,
        avg_hold_duration_hours: w?.avg_hold_duration_hours ?? null,
        wins_7d: w?.wins_7d || 0,
        losses_7d: w?.losses_7d || 0,
        wins_30d: w?.wins_30d || 0,
        losses_30d: w?.losses_30d || 0,
        wins_all: w?.wins_all || 0,
        losses_all: w?.losses_all || 0,
